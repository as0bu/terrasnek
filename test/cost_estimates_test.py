"""
Module for testing the Terraform Enterprise API Endpoint: Cost Estimates.
"""
...
class TestTFCCostEstimates(TestTFCBaseTestCase):
    ...
    def setUp(self):
        ...
        _ws_payload = self._get_ws_with_vcs_create_payload("cost-estimates", oauth_token_id)
    ...
    def test_cost_estimates(self):
        """
        Test the Cost Estimates API endpoint: show.
        """
